...
@media screen and (max-height: 450px) {
    ...
    <div id="header">
        ...
        @endforeach
                        ...
                        <h2>Which User do you want to delete?</h2><br>
                        <select name="user_id">
                        @foreach($userlist as $users)
                            <option value="{{$users->user_id}}">{{$users->Username}}</option>
                        @endforeach
                        </select></td>
                        <button type="submit" name="Delete" onclick="return confirm('Are you sure you want to delete??')">Submit</button>
