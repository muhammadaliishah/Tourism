...
@media screen and (max-height: 450px) {
    ...
    <div id="header">
        ...
        <center>
            <form method="post" action="/admin/acceptbook">
                <input type="hidden" name="b_id" value="{{$bookings->b_id}}">
                <input type="hidden" name="h_id" value="{{$bookings->h_id}}">
                <input type="hidden" name="no_rooms" value="{{$bookings->no_rooms}}">
                ...
                <div id="body">
                    <div id="content">
                        ...
                        <button type="submit" name="Delete" onclick="return confirm('Are you sure you want to accept??')">Accept</button>
