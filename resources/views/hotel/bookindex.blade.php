...
@media screen and (max-height: 450px) {
    ...
    <h2 style="text-align: center; margin-top: 20px;">Book your Hotel</h2>
        ...
        <center>
                ...
                <div id="body">
                    <div id="content">
                            ...
                            <form method="post" action="/hotel/{{$hotel->h_id}}">
                                {{csrf_field()}}
                        ...
                        <td>
                            <input type="number" placeholder="No. of rooms" min='1' max='{{$hotel->Total_room-$hotel->Booked_room}}' name="no_rooms"><br>
                        </td>
                        </tr>
                        <tr>
                            <td>
