...
@media screen and (max-height: 450px) {
    ...
    <div id="header">
                 <div id="content">
                    ...
                    <span style="font-size:30px;cursor:pointer;position:relative;right:890px " onclick="openNav() " >&#9776;</span>
                    
                </div>
            </div>
        <center>
            <form method="post" action="/admin/hotelinfobook">
        ...
        @foreach($hotelList as $hotel)
                                <tr>
                                    ...
                                    <td>
                                        <a href ="/admin/hotelinfo/{{$hotel->h_id}}/edit1">Update</a>
                                    </td>
                                    <td>
                                        <a href ="/admin/hotelinfo/{{$hotel->h_id}}/delete1">Delete</a>
                                    </td>
                        ...
                        <h2>Which Hotel do you want to book? </h2><br>
                        <select name="h_id">
                        @foreach($hotelList as $hotel)
                            <option value="{{$hotel->h_id}}">{{$hotel->h_name}}</option>
                        @endforeach
                        </select></td>
                        <input type="number" placeholder="Book rooms" name="bookrooms" min='{{$hotel->Booked_room}}'><br>
